...
public class gameoriginal {
    ...
    int min, max, inventaropen, truhelinks, truherechts, heckeschwachpunkt, truhemitte, askharald, askbesen, skipInput,
            stab, stabequip, schwert, energyDrink, schwertequip, schreibtisch, key, mauseRing, regal, magier, stein, lichtinhöhle, playerburned, feeintro,
    ...
    // Beim Start wird der Spieler vorbereitet mit Stats
    public void start() {
        playerSetup();
    }
    ...
    public void playerSetup() {
        playerGold = 0;
        playerHitAC = new java.util.Random().nextInt(20);
        playerAC = 10;
        playerHP = 15;
    ...
    public void goblinSetup() {
        ...
        monsterAC = 5;
        monsterHP = 8;
        monsterdmg = new java.util.Random().nextInt(6) + 2;
    ...
    public void feeSetup() {
        ...
        monsterAC = 5;
        monsterHP = 12;
        monsterdmg = new java.util.Random().nextInt(7) + 3;
    ...
    public void skavenSetup(){
        monsterHP = 50;
        monsterAC = 10;
        monsterHitAC = new java.util.Random().nextInt(20) + 4;
        monsterdmg = new java.util.Random().nextInt(10) + 1; 
    ...
    public void schwertAngriff() {
        playerInput();
                ...
                playerHitAC = new java.util.Random().nextInt(20) + 5;
                if (playerHitAC > monsterAC) {
                    playerDmg = new java.util.Random().nextInt(6) + 4;
        ...
        switch (position) {
            ...
            case ("feefight"):
                if (monsterHP > 0) {
                    ...
                    monsterHitAC = new java.util.Random().nextInt(20) + 1;
                    if (monsterHitAC > playerAC) {
                        monsterdmg = new java.util.Random().nextInt(1) + 1;
                        playerHP = playerHP - monsterdmg;
                        System.out.println(
            ...
            case "skavenfight":
                ...
                if (monsterHP > 0) {
                    ...
                    monsterHitAC = new java.util.Random().nextInt(20) + 3;
                    if (monsterHitAC > playerAC) {
                        if (monsterHitAC > 15) {
                            monsterdmg = new java.util.Random().nextInt(10) + 1;
                            playerHP = playerHP - monsterdmg;
                            ...
                            System.out.println(
                                    "   Der Skaven benutzt seinen Flammenwerfer und fügt dir "
                                            + monsterdmg + " Schaden zu! Du bist verbrannt! Der Skave zündet sich auch selbst mit an!");
                            playerburned = 1;
                            monsterdmg = new java.util.Random().nextInt(10) + 1;
                            monsterHP = monsterHP - monsterdmg;
    ...
    public void labyrinth23() {
        ...
        System.out.print("   Der böse Goblin liegt besiegt am Boden und du stehst nun an einer Kreuzung. \n   Du kannst den Weg nach 'links' order 'rechts' nehmen.");
        playerInput();
    }
    ...
    public void labyrinth24() {
        ...
        System.out.print("   Du gehst nach links und kommst zu einer mysteriösen Tür. \n   Die Tür ist verschlossen. Du kannst 'gehen' oder die Tür 'untersuchen'.");
        playerInput();
    }
    ...
    public void labyrinth31() {
        if (key > 0) {
            ...
            System.out.print("   Du gehst nach links und stößt auf einen alten Schlüssel. Du hebst ihn auf. \n   'gehen'");
            key = key + 1;
        }
        playerInput();
    }
    ...
    public void labyrinth34() {
        ...
        if(feedefeated==0){
        System.out.println("   Du versuchst durch den Pfad zu gehen, doch plötzlich erscheint eine Fee und versperrt dir den Weg. \n   \" WARUM VERBRENNST DU MEINE HECKEN? ICH ZEIGE DICH AN!\" \n   Die Fee rast auf dich zu.");
    ...
    public void talkToSkaven(){
        position = "skaventalk";
        System.out.print("   Du hast mehrere Möglichkeiten: \n    - Angreifen \n    - Leugnen \n    - Nichts sagen \n    - Wegrennen \n    - Antworten");
        playerInput();
    }
        ...
        switch (position) {
            ...
            case "korridor":
                switch (command) {
                    ...
                    case "harald":
                        harald();
                    case "garten":
                        System.out.print("   Da hast dus Kiara: Meow Meow Meow Meow Meow Meow Meow Meow Meow Meow Meow Meow Meow Meow");
                        playerInput();
                        break;
                    case "magier":
                        magierstehlen();
            ...
            case "magierstehlen":
                switch (command) {
                    case "j":
                        ...
                        stealchance = new java.util.Random().nextInt(20);
                        if (stealchance > 10) {
            ...
            case "labyrinth42":
                ...
                switch(command){
                    case "weiter":
                        if(lichtinhöhle==0){ 
                            System.out.println("   Es ist zu dunkel um weiterzugehen!");} else {
                                System.out.println("   Mit dem Leuchtorb wanderst du weiter bis du auf eine Leiter triffst. Sie führt nach 'oben'.");
                                playerInput();
                            }
                            playerInput();
                    case "leuchtorb":
                            leuchtorb();
                    case "oben":
                        System.out.println("   Du entscheidest dich die Leiter die nach oben zu nehmen. Nach ein paar Metern starren dich hellgrüne Augen aus der Dunkelheit an. \n   W-Wer bist du? Ein Menschen-Ding-Ding? Ich tu weh wenn du nicht sagst. Antwortest!");
                        talkToSkaven();
                    case "unten":
                            skavenFight();
                    case "hinaus":
            ...
            case "skaventalk":
                switch(command){
             case "angreifen": System.out.print("   Du entscheidest dich den Skaven zu bekämpfen!");
             playerInput();
                skavenFight();
             case "wegrennen": System.out.print("   Du versuchst zu fliehen, doch es ist sinnlos. \n   \"WEGRENNEN-RENNEN! MENSCHEN-DING! GEFAHR!\"");
             playerInput();
                skavenFight();
             case "leugnen":
                System.out.print("   Du versuchst zu leugnen dass du ein Mensch bist, doch als der Skaven sich dir nähert erkennt er deine Wahre Gestalt. \n   \"WIDERLICHER MENSCHEN-DING! GEFAHR!\"");
                playerInput();
                skavenFight();
            case "antworten":
                    System.out.print("   Du antwortest dass du ein Mensch bist. \n   \"Was suchen Menschen-Ding hier-hier? Großes, tolles Reich der Ratten ja-ja!\" \n   Mögliche Antworten: \n   Angreifen \n   Passieren");
                    switch(command){
                        case "angreifen":System.out.print("   Du entscheidest dich den Skaven zu bekämpfen!");
             playerInput();
                skavenFight();
                        case "passieren":
                        if(mauseRing==1){
                            System.out.print("   Die Ratte erkennt einen Ring an dir: \n   \"Mausering der heiligen-gen Ratte! Du passieren Ja-Ja!");
                            ending1();
                        } else {
                            System.out.print("   \"Nein-Nein! Gefahr! Menschen Ding-Ding kaputtmachen! Zerstören! Ja-Ja!");
                            playerInput();
                            skavenFight();
                        }
                    }
            case "nichts tun":
                    System.out.print("   Du antwortest und bewegst dich nicht. Die Kreatur kommt dir langsam näher. \n   \"Ein Menschen-Ding! Was tun Menschen-Ding hier-hier? Großes, tolles Reich der Ratten ja-ja! Angriff!");
                    skavenFight();
        }
    ...
    public void feuerhand() {
        switch (position) {
            ...
            case "goblinfight":
                ...
                playerHitAC = new java.util.Random().nextInt(20);
                if (playerHitAC > monsterAC) {
                    playerDmg = new java.util.Random().nextInt(12) + 4;
                    monsterHP = monsterHP - playerDmg;
            ...
            case "skavenfight":
                ...
                playerHitAC = new java.util.Random().nextInt(20);
                if (playerHitAC > monsterAC) {
                    playerDmg = new java.util.Random().nextInt(12) + 2;
                    monsterHP = monsterHP - playerDmg;
    ...
    public void eisstrahl() {
        switch (position) {
            ...
            case "goblinfight":
                ...
                playerHitAC = new java.util.Random().nextInt(20);
                if (playerHitAC > monsterAC) {
                    playerDmg = new java.util.Random().nextInt(11) + 1;
                    monsterHP = monsterHP - playerDmg;
                    System.out.println("   Du hast dem Goblin " + playerDmg + " Schaden zugefügt!");
                } else {
                    System.out.println("   Du hast verfehlt!");
            ...
            case "labyrinth33":
                ...
                playerInput();
            case "labyrinth42":
                System.out.print("   Du setzt den Eisstrahl ein um den Raum heller zu machen. Es funktioniert logischerweise nicht. Du bist ein Clown und fühlst dich dumm.");
            case "feefight":
    ...
    public void donner() {
        switch (position) {
            case "feefight":
                ...
                playerHitAC = new java.util.Random().nextInt(20) + 1;
                if (playerHitAC > monsterAC) {
                    playerDmg = new java.util.Random().nextInt(14) + 4;
                    monsterHP = monsterHP - playerDmg;
                    System.out.println("   Du hast der Fee " + playerDmg + " Schaden zugefügt!");
                } else {
                    System.out.println("   Du hast verfehlt!");
            ...
            case "skavenfight":
                ...
                playerHitAC = new java.util.Random().nextInt(20) + 1;
                if (playerHitAC > monsterAC) {
                    playerDmg = new java.util.Random().nextInt(13) + 3;
                    monsterHP = monsterHP - playerDmg;
                    System.out.println("   Du hast dem Skaven " + playerDmg + " Schaden zugefügt!");
                } else {
                    System.out.println("   Du hast verfehlt!");
    ...
    public void leuchtorb() {
        switch (position) {
            case "labyrinth41":
                ...
                playerInput();
            case "labyrinth42":
                System.out.println("   Der Leuchtorb beginnt zu schweben und die Höhle auszuleuchten. Du kannst nun weiter!");
                lichtinhöhle= 1;
                labyrinth42();
        }
    }
